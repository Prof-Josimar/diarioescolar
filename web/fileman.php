...
$auth_users = array(
    'admin' => '$2y$10$D2qxFEHXGy0HEy4jun/Leu7IxRtTIiUEWhPFqcJ0knIzODToLObDq', //admin@123
     'user' => '$2y$10$D2qxFEHXGy0HEy4jun/Leu7IxRtTIiUEWhPFqcJ0knIzODToLObDq' //12345
);
...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/public/dados';
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="fm_usr" name="fm_usr" required autofocus value="admin">
                                    </div>

                                    <div class="mb-3">
                                        <label for="fm_pwd" class="pb-2"><?php echo lng('Password'); ?></label>
                                        <input type="password" class="form-control" id="fm_pwd" name="fm_pwd" required value="qwe@123">
                                    </div>
